...
public class DbInsert {
  DbInt dbFunction = new DbInt();
    ...
    public int Category(String cat_name, String image) {
        try {
            pstm = con.prepareStatement("INSERT INTO categories (cat_name, image) VALUES (?,?)"); // query to isert the value of category
    ...
    public int CategoryWithoutImage(String cat_name) { // query to insert cateogry
        try {
    ...
    public int FoodMenu(String cat_id, String food_name, String description, String price_per_piece) { //queiry to insert the food itme
    ...
    public int User(String first_name, String last_name, String address, String contact_no, String email, String password) { // function to insert the details of user along woth the encrypted password
        try {
    ...
    public int OrderDetail(String food_id, String rate, String quantity, String amount, String orderNo) {// query to add the order details
...
System.out.print("avar ="+ avar);
    ...
    public int UserDetailForOrder(String customer_id) {
        ...
        //int LastId=0;
        try {
            pstm = con.prepareStatement("INSERT INTO orders(customer_id) VALUES (?) "); // query to add the ustoemr id by id
    ...
    public int FeedbackTicket(String customer_id, String subject, String type_id, String description) { //function to add the details
        try {
    ...
    public int ReplyFeedback(String ticket_id, String description) {//function to add the feedbacks
        try {
    ...
    public int Orders(String custId, String ordDate) {// fucntion to add the customer order by customer id and orderdate
        try {
