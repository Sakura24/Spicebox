...
//        }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            //out.print(email);
            if (email == 1) { // creating conditon for email validaion
                int password = dbObj.ValidatePassword(request.getParameter("email"), request.getParameter("password"));
                out.print(password);
                if (password == 1) {//creating conditon of emai password validation
                    ...
                    if (user_type.equals("Customer")) {
                        ...
                        out.print("your user type is not inserted in the system");// displaying error is the condition does not mathc
                    }
                }
            }
