...
public class DbUpdate {
    ...
    public int UpdateCategoryImage(String image) {
        try {
            pstm = con.prepareStatement("UPDATE categories SET image=?");
    ...
    public int updateFoodMenu(String food_name, String description,String price_per_piece, int food_id) {
        try {
    ...
    public int UpdateOrdersByOrderId(String deliver_address, String description, String total, String order_id) {
        try {
     ...
     public int UpdateTotalByOrderId(String total, String order_id) {
        try {
     ...
     public int updateUser(String first_name, String last_name, String address, String contact_no, String email, String password, int user_id) {
        try {
    ...
    public int updateProfile(String first_name, String last_name, String address, String contact_no, String email, String password, int user_id) {
        try {
    ...
    public Integer UpdateReplyStatus(String ticket_id) {
        try {
     ...
     public Integer UpdateQuantity(String quantity, String amount, String od_id) {
        try {
     ...
     public Integer OrderStatus(String order_id) {
        try {
    ...
    public Integer UpdateGrandTotal(double service, double vat, String order_id) {
        try {
