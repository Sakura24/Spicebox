...
public class DbDelete {
    ...
    public int DeleteFoodItem(String food_id) {
        try {
            pstm = con.prepareStatement("DELETE FROM fooditems WHERE food_id=?");
    ...
    public int DeleteFoodOrder(String od_id) {
        try {
            pstm = con.prepareStatement("DELETE FROM order_details WHERE od_id=?");
    ...
    public int DeleteOrderList(String order_id) {
        try {
            pstm = con.prepareStatement("DELETE FROM orders WHERE order_id=?");
    ...
    public int DeleteFeedbackList(String ticket_id) {
        try {
            pstm = con.prepareStatement("DELETE FROM feedbacks WHERE ticket_id=?");
